...
int main() 
{
    try {
        ...
        glm::vec3 Oa_b(1.0f, 0.0f, 0.0f);
        glm::vec3 AmbientColorBack(Ka * Oa_b);

        float     Kd = 0.75f;
        // float     Kd = 0.3f;
        glm::vec3 Od(0.0f, 1.0f, 0.0f);
        glm::vec3 DiffuseColor(Kd * Od);
        glm::vec3 Od_b(1.0f, 0.0f, 0.0f);
        glm::vec3 DiffuseColorBack(Kd * Od_b);

        float     Ks = 0.9f;
        // float     Ks = 0.7f;
        glm::vec3 Os(1.0f, 1.0f, 1.0f);
        glm::vec3 SpecularColor(Ks * Os);
        glm::vec3 SpecularColorBack(Ks * Os);
        ...
        GLuint ambientcolorback  = glGetUniformLocation(triangleshaderID, "AmbientColorBack");
        GLuint diffusecolor      = glGetUniformLocation(triangleshaderID, "DiffuseColor");
        GLuint diffusecolorback  = glGetUniformLocation(triangleshaderID, "DiffuseColorBack");
        GLuint specularcolor     = glGetUniformLocation(triangleshaderID, "SpecularColor");
        GLuint specularcolorback = glGetUniformLocation(triangleshaderID, "SpecularColorBack");
